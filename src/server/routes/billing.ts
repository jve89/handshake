  ...
  async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      const successUrl = origin
        ? `${origin}/dashboard/handshakes?billing=success`
        : "/dashboard/handshakes?billing=success";
      const cancelUrl = origin
        ? `${origin}/dashboard/handshakes?billing=cancel`
        : "/dashboard/handshakes?billing=cancel";
